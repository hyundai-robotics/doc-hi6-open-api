...
[1.5 Postman 에서 POST 요청하기](../../1-intro/5-postman/1-description.md)에서 간단한 사용법을 확인할 수 있습니다.
...
[1.6 웹 브라우저에서 API 호출하기](../../1-intro/6-web-api-call/1-description.md)에서 간단한 사용법을 확인할 수 있습니다.