...
1. [http connection](./1-http-connection.md)## 1. Keep-Alive vs Close connection
{% hint style="caution" %}
...
- API 별로 정확한 request-body 를 작성해야합니다.<div style="width: fit-content;">
