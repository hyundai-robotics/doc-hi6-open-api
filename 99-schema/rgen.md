...
|22|cur_mech_no|`int`||
|23|cur_mode|`int`|0: 手动<br>1: 手动（系统决定）<br>3: 自动，1周期<br>4: 自动，连续（循环重复）|
...
|33|enable_state|`int`|字节0 (LSB): 电机开启 (0: 开 / 1: 关 / 2: 繁忙)<br>字节1: TP 使能 (死手) 开关 (0: 关闭 / 1: 开启)<br>字节2: 机器锁 (0: 关闭 / 1: 开启)<br>字节3: 枪锁 (0: 关闭 / 1: 开启)<br>字节4: 枪使能 (0: 关闭 / 1: 开启)|
|34|eng_code|`int`||
...
|45|jog_inch_status|`int`|Jog 英寸状态 (0: 关闭 / 1: 打开)|
|46|load_esti|`int`||
