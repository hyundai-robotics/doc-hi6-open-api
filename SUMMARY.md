...
* [1. Intro](./1-intro/1-intro.md)
  * [1.1 Overview](./1-intro/1-intro.md#11-overview)
    ...
    * [1.1.2 Be sure to check before you start!](./1-intro/1-intro.md#112-be-sure-to-check-before-you-start)
  * [1.2 Required prior knowledge](./1-intro/2-prerequisite.md#12-required-prior-knowledge)
    * [1.2.1 What is an API?](./1-intro/2-prerequisite.md#121-what-is-an-api)
    * [1.2.2 What is REST API?](./1-intro/2-prerequisite.md#122-what-is-rest-api)
  ...
  * [1.4 Simple API call without coding](./1-intro/4-api-test.md#14-simple-api-call-without-coding)
    * [1.4.1 Using postman](./1-intro/4-api-test.md#141-using-postman)
    * [1.4.2 Using Web Browser](./1-intro/4-api-test.md#142-using-web-browser)
  * [1.5 Requesting POST in Postman](./1-intro/5-postman.md#15-requesting-post-in-postman)
    * [1.5.1 Main UI composition](./1-intro/5-postman.md#151-main-ui-composition)
    * [1.5.2 Testing POST Requests](./1-intro/5-postman.md#152-testing-post-requests)
  * [1.6 Calling API from web browser](./1-intro/6-web-api-call.md#16-calling-api-from-web-browser)
    * [1.6.1 Make a simple GET request](./1-intro/6-web-api-call.md#161-make-a-simple-get-request)
    * [1.6.2 Calling API with extension](./1-intro/6-web-api-call.md#162-calling-api-with-extension)
